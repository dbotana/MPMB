...
RaceList["hengeyokai"] = {
    ...
    scoresGeneric : false,
    scores : [0, 0, 0, 0, 0, 1], // +1 to Charisma
...
AddRacialVariant("hengeyokai", "carp", {
    ...
    scores : [0, 1, 1, 0, 0, 0], // +1 Dex, +1 Con
    weaponOptions : [{
    ...
    trait : "Carp Hengeyokai (+1 Dexterity, +1 Constitution, +1 Charisma)" +
        "\n \u2022 Perseverance: I have proficiency in Athletics and Survival." +
...
AddRacialVariant("hengeyokai", "cat", {
    ...
    trait : "Cat Hengeyokai (+2 Dexterity, +1 Charisma)" +
        "\n \u2022 Sneaky and Flexible: I have proficiency in Acrobatics and Stealth." +
...
AddRacialVariant("hengeyokai", "dog", {
    ...
    trait : "Dog Hengeyokai (+2 Strength, +1 Charisma)" +
        "\n \u2022 Man's Best Friend: I have proficiency in Athletics and Insight." +
...
AddRacialVariant("hengeyokai", "fox", {
    ...
    scores : [0, 1, 0, 0, 0, 1], // +1 Dex, +1 Cha (total +2 Cha with base)
    vision : [["Keen Smell and Hearing", 0]],
    weaponOptions : [{
        baseWeapon : "unarmed strike",
    ...
    trait : "Fox Hengeyokai (+1 Dexterity, +2 Charisma total)" +
        "\n \u2022 Trickster: I have proficiency in Deception and Persuasion skills. I also double my proficiency bonus in Charisma (Deception) checks." +
    ...
    calcChanges : {
        skillAdd : [
            function(skillObj) {
                if (skillObj.name === "Deception") {
                    skillObj.expert = true;
                }
            },
            "I double my proficiency bonus for Deception checks."
        ]
    }
});
...
AddRacialVariant("hengeyokai", "raccoon dog", {
    ...
    scores : [0, 0, 1, 0, 0, 1], // +1 Con, +1 Cha (total +2 Cha with base)
    speed : {
        walk : { spd : 30, enc : 20 },
        climb : { spd : 30, enc : 20 }
    },
    ...
    trait : "Raccoon Dog Hengeyokai (+1 Constitution, +2 Charisma total)" +
        "\n \u2022 Charm of a Merchant: I have proficiency in Insight and Persuasion skills. I also have advantage on Charisma (Persuasion) and Charisma (Deception) checks regarding money." +
        ...
        "\n \u2022 Climber: I have a climbing speed of 30 feet in both forms.",
    advantages : [
        ["Persuasion", true, "if regarding money"],
        ["Deception", true, "if regarding money"]
    ]
});
...
AddRacialVariant("hengeyokai", "sparrow", {
    ...
    scores : [0, 1, 0, 0, 1, 0], // +1 Dex, +1 Wis
    weaponOptions : [{
        baseWeapon : "unarmed strike",
    ...
    trait : "Sparrow Hengeyokai (+1 Dexterity, +1 Wisdom, +1 Charisma)" +
        "\n \u2022 Friend of the Honest: I have proficiency in Acrobatics and Insight skills." +
